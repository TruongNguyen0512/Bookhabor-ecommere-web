...
public class SanPhamDAO implements DAOInterface<SanPham> {
	...
	public ArrayList<SanPham> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				SanPham sp = new SanPham(masanpham, tensanpham, namxuatban, gianhap, giagoc, giaban, soluong,
	...
	public SanPham selectById(SanPham t) {
		...
		try {
			...
			while (rs.next()) {
				...
				ketQua = new SanPham(masanpham, tensanpham,  namxuatban, gianhap, giagoc, giaban, soluong,
						theLoai, ngonngu, mota);
				break;
			}
	...
	public int insert(SanPham t) {
		...
		try {
			...
			// Bước 2: tạo ra đối tượng statement
			String sql = "INSERT INTO sanpham (masanpham,tensanpham,namxuatban,"
	...
	public int update(SanPham t) {
		...
		try {
			...
			// Bước 2: tạo ra đối tượng statement
			String sql = "UPDATE sanpham " + " SET " + "tensanpham=?, namxuatban=?, gianhap=?, giagoc=?, "
			...
			st.setString(8, t.getNgonNgu());
			st.setString(9, t.getMoTa());
			st.setString(10, t.getMaSanPham());
			// Bước 3: thực thi câu lệnh SQL
	...
	public boolean kiemTraTenSanPham(String tenSanPham) {
