	...
	public ArrayList<ChiTietDonHang> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				DonHang dh = new DonHangDAO().selectById(new DonHang(donhang, null, "", "", "", "", sanpham, 0, 0, null, null));
				SanPham sp = new SanPhamDAO().selectById(new SanPham("", "", 0, 0, 0, 0, 0, null, "", ""));
	...
	public ChiTietDonHang selectById(ChiTietDonHang t) {
		...
		try {
			...
			while (rs.next()) {
				...
				DonHang dh = new DonHangDAO().selectById(new DonHang(donhang, null, "", "", "", "", sanpham, 0, 0, null, null));
				SanPham sp = new SanPhamDAO().selectById(new SanPham(sanpham, "", 0, 0, 0, 0, 0, null, "", ""));
