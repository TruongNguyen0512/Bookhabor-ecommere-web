				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="khoahoc.jsp">Khoa Học</a></li>
							<li><a class="dropdown-item" href="vanhoc.jsp">Văn Học</a></li>
							<li><hr class="dropdown-divider"></li>
							<li><a class="dropdown-item" href="doisong.jsp">Đời Sống</a></li>
						</ul></li>
